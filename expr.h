...
// assign a value to an id by creating a temp symbole that contain the
// value and a quad "id = temp"
struct symbol* affectation(int type, char* id, struct symbol* res,
						   struct quad** code, struct quad* q, int declare);

// perform the computation of arg1 op arg2
